...
$APPLICATION->SetPageProperty("description", "Мы изготовим витражи и цветные стеклопакеты для окон разнообразных форм. Доставка и монтаж.");
$APPLICATION->SetPageProperty("keywords", "Витражи, цветные стеклопакеты, ламинация окон, разнообразные формы окон, раскладки.");
$APPLICATION->SetPageProperty("title", "Дополнительные возможности окон - витражи, цветные стеклопакеты, ламинация окон, разнообразные формы окон, раскладки");
