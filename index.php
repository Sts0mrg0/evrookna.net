...
$APPLICATION->SetTitle("Пластиковые окна в Москве от производителя «Современные окна» | Евроокна – официальный сайт, отзывы, цены, преимущества");
?>
<div class="sl">
    <div class="slider">
...
Акция! Закажи ПВХ окна сейчас - получи подарок!
    ...
    <div class="clients">
        <div class="main-icon">
            ...
            <div class="icon">
                ...
                <p>
                    Наши окна не пропустят звук и тепло, сделаны из экологических материалов. Качество контролируется по
                    ГОСТ 1234-5
                </p>
            </div>
            <div class="icon">
    ...
    <div class="clients" style="padding-bottom: 40px">
            ...
            Компания «Современные евроокна» - предприятие по изготовлению и установке окон из профиля VEKA и деревянного
            бруса. Мы делаем надежные, качественные окна, отвечающие современным представлениям о комфорте и
            энергосбережении, на самых привлекательных для вас условиях.


            Наши конкурентные преимущества:
        <ul>
            <li>Собственные производственные мощности по изготовлению окон, благодаря чему мы выполняем заказы быстро,
                качественно и удерживаем низкие цены на весь ассортимент;
            </li>
            <li>Использование комплектующих от лучших производителей Европы;</li>
            <li>Высокий профессионализм сотрудников, скрупулезное соблюдение технологии;</li>
            <li>Возможность реализовать любые пожелания заказчика, в том числе <a
                    href="http://www.eurookna.net/extra/nonstandard/">изготовление окон нестандартных размеров и
                    форм</a>, остекление поверхностей со сложной геометрией и пр.
            </li>
        </ul>

            Мы предлагаем широчайшую гамму дополнительных аксессуаров, которые сдела-ют ваши окна еще более элегантными,
            надежными и комфортными в пользовании. Это:<br>
        <ol>
            <li>энергосберегающее стекло;</li>
            <li>дополнительная шумоизоляция;</li>
            <li>функция самоочистки;</li>
            <li>усиленная взломобезопасность;</li>
            <li>фиксаторы для детской безопасности;</li>
            <li><a href="http://www.eurookna.net/kit/mosquito_netting/">москитные сетки</a>;</li>
            <li><a href="http://www.eurookna.net/extra/stained/">цветные стекла и витражи</a>;</li>
            <li>декоративные раскладки;</li>
            <li><a href="http://www.eurookna.net/extra/lamination/">ламинация цветной пленкой</a>.</li>
        </ol>
    </div>
    <div class="main-index">
        <div class="index-width">
