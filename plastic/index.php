...
$APPLICATION->SetPageProperty("description", "Пластиковые окна из высококачественного профиля VEKA. Мы предлагаем классические, а также нестандартные пластиковые окна по доступным ценам.");
$APPLICATION->SetPageProperty("keywords", "Пластиковые онка, окна VEKA.");
