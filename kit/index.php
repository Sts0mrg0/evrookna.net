...
$APPLICATION->SetPageProperty("description", "У нас вы можете заказать пластиковые окна и все комплектующие к ним: москитные сетки, подоконники.");
$APPLICATION->SetPageProperty("keywords", "Комплектующие для пластиковых окон, москитные сетки, подоконники, откосы, отливы.");
$APPLICATION->SetPageProperty("title", "Комплектующие для пластиковых окон - продажа, доставка и монтаж");
